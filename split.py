...
parser.add_argument('--src', default='/home/ma-user/work/xwma/data/DSIFN', type=str, help='path for the original dataset')
parser.add_argument('--tar', default='/home/ma-user/work/xwma/code/BIT_CD-master/data', type=str, help='path for saving the new dataset')
parser.add_argument('--image_sub_folder', default='t1,t2,mask', type=str, help='name of subfolder inside the training, validation and test folders')
parser.add_argument('--set', default="train", type=str, help='evaluation mode')
parser.add_argument('--patch_width', default=512, type=int, help='Width of the cropped image patch')
parser.add_argument('--patch_height', default=512, type=int, help='Height of the cropped image patch')
parser.add_argument('--stride', default=512, type=int, help='Overlap area')
            ...
            if img_H >= patch_H and img_W >= patch_W:
                for x in range(0, img_H, stride):
                    ...
                    for y in range(0, img_W, stride):                      
                        ...
                        image = file_[:-4]+'_'+str(x_str)+'_'+str(x_end)+'_'+str(y_str)+'_'+str(y_end)+'.png'
...
with open(txt_path, 'w') as f:
    txt_1, txt_2, txt_3 = txt_list['t1'], txt_list['t2'], txt_list['mask']
